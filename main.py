...
if __name__ == '__main__':
    ...
    parser.add_argument("--seed", type=int, help="random_seed", default=2)
    parser.add_argument("--config_path", type=str, help="path of config file", default='configs/HAR.ini')
    parser.add_argument('--selected_dataset', default='HAR', type=str, help='Dataset of choice: SAD, HAR, JapVo, TEP, flotation, NATOPS')
    ...
    parser.add_argument('--pretrain_dic', type=str, help='pretrain model directory')
    ...
    train_dl, test_dl, trainAll_dl, val_dl = data_generator(dataset_name, args)  # [b,c,l]
    ...
    trainer = Trainer(args, model, train_dl, test_dl, trainAll_dl, val_dl, logger, optimizer, saved_model, indexes)
    ...
    # trainer_part = Trainer(args, model, train_part_dl, test_dl, trainAll_dl, val_dl, logger, optimizer, saved_model, indexes)
    # trainer_part.fine_tune(args.pretrain_dic)

    # trainer_part = Trainer(args, model, train_dl, test_dl, trainAll_dl,val_dl, logger, optimizer, saved_model, indexes)
