...
class Layer(nn.Module):
    def __init__(self,args,input_channel,d_model,kernel_size,layers,idx):
        ...
        # self.decoder_pro = nn.Linear(self.d_model,self.d_model)
    ...
    def pretrain_forward(self,last_layer_out,x_now,index_now, index_next):
        ...
        # mask_rec = self.decoder_pro(all_imputation[:,:mask_len,:])
        # loss = self.imputationloss(input_copy[:, m_index, :],mask_rec)
