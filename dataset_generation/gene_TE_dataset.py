...
if __name__ == '__main__':
    ...
    initValidDataSet = scorelabelData[8000:10000,:]
    ...
    valid_data,valid_labels = sliding_window_non_overlap(initValidDataSet,24,covariates_idx,y_idx)
    ...
    dat_dict = dict()
    dat_dict["samples"] = torch.from_numpy(valid_data).transpose(1,2)
    dat_dict["labels"] = torch.from_numpy(valid_labels).transpose(1,2)
